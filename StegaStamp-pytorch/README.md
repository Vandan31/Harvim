# Please use a different PC.Model is in training 
...
```bash
python -m stegastamp.encode_image   --model ./asset/best.pth   --image ./asset/harvim_dog.png   --save_dir ./outputs/demo   --secret "sheru i"   --height 400 --width 400 --secret_size 100
```
...
```bash
python -m stegastamp.decode_image --model ./asset/best.pth  --image ./outputs/demo/harvim_dog_hidden.png --height 400 --width 400 --secret_size 100
```
